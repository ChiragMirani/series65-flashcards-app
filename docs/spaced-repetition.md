...
- All subjects includes every active card (703 in the current deck). Subject selections include all active cards in that category: laws 347, recommendations 198, vehicles 125, economics 33. Suspended cards are excluded. Due dates and legacy daily/session caps do not restrict full-deck selection.
