...
- All subjects includes every active card (628 in the current deck). Subject selections include all active cards in that category: laws 321, recommendations 187, vehicles 92, economics 28. Suspended cards are excluded. Due dates and legacy daily/session caps do not restrict full-deck selection.
